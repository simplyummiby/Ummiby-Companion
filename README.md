...
v0.6.6.4 — Classic Reading Progress Polish

## Current Release

Version 0.6.6.4 refines Classic Reading progress: reader and journey-page progress now represent the current surah, while overall Quran progress remains on Quran Home. Displayed percentages are rounded to whole numbers.
