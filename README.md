...
Version 0.7.5.2 adds persistent surah-level memorization statuses, status colors, live dashboard totals, and quick status changes from both the Surah Library and each surah detail page.
