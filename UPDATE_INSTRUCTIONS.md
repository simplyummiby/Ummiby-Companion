# Update Instructions — Ummiby Companion v0.7.2.2

This package updates Ummiby Companion v0.7.1 to v0.7.2.2.

## Recommended update method

1. Back up your existing app data from **Backup & Restore**.
2. Extract the v0.7.2.2 ZIP.
...
- Updated the app version and release documentation to v0.7.2.2.
