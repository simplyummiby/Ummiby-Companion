# Update Instructions — Ummiby Companion v0.7.8.1

This package updates Ummiby Companion to v0.7.8.1.

## What changed in v0.7.8.1
...
1. Open `settings.html` and confirm the app shows v0.7.8.1.
